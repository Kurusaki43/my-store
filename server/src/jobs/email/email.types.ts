...
export type PasswordResetEmailData = { type: 'password-reset'; to: string; resetLink: string };
export type OrderConfirmEmailData = { type: 'order-confirm'; to: string; orderId: string; items: OrderItem[]; total: number };
